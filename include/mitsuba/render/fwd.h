...
template <typename Float, typename Spectrum> class LightTracerIntegrator;
...
template <typename Float_, typename Spectrum_> struct RenderAliases {
    ...
    using LightTracerIntegrator  = mitsuba::LightTracerIntegrator<FloatU, SpectrumU>;
...
#define MTS_IMPORT_OBJECT_TYPES()                                                                  \
    ...
    using LightTracerIntegrator  = typename RenderAliases::LightTracerIntegrator;                  \
