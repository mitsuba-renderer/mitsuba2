...
def create_single_triangle():
    ...
    m = Mesh("tri", 3, 1)
    params = traverse(m)
    params['vertex_positions_buf'] = [0.0, 0.0, 0.0, 1.0, 0.2, 0.0, 0.2, 1.0, 0.0]
    params['faces_buf'] = [0, 1, 2]
    params.update()
    return m
...
def create_regular_tetrahedron():
    ...
    params = traverse(m)
    params['vertex_positions_buf'] = [0, 0, 0, 0.8, 0.8, 0, 0.8, 0, 0.8, 0, 0.8, 0.8]
    params['faces_buf'] = [0, 1, 2, 1, 2, 3, 0, 2, 2, 1, 3, 3, 3, 1, 0]
    params.update()
    return m
...
def create_stairs(num_steps):
    ...
    params['vertex_positions_buf'] = v.reshape(-1)
    params['faces_buf'] = f.reshape(-1)
    params.update()
    return m
